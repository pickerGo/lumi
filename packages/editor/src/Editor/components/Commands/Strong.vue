...
export default defineComponent({
    ...
    setup(props) {
        ...
        return () => (
            <div class={[props.active ? 'active' : '']} onClick={() => handleAction(schema.marks.strong)}>
                <Tooltip title={i18next.t('editor.commands.strong')}>
                    <LucideIcon icon={Bold} width={props.iconSize}></LucideIcon>
                </Tooltip>
            </div>
        );
    },
