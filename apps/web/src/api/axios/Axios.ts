...
import type { RequestOptions, Result, UploadFileParams, UploadFileCallBack } from './interface';
import { ContentTypeEnum, RequestEnum } from './interface';
...
export class VAxios {
   ...
   * @param formData
   */
  uploadMyFile<T = any>(url: string, formData: FormData) {
